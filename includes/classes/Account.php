  ...
  class Account{
	...
	private function validatePasswords($pw, $pw2){
		...
		if(preg_match('/[^A-Za-z0-9@*$]/', $pw)){
			array_push($this->errorArray, "Your passwords can only contain Numbers, Letter, @, * and $");
			return;
		}
		if(strlen($pw) > 30 || strlen($pw) < 15){
			array_push($this->errorArray, "Your password must be between 15 and 30 Characters");
			return;
		}
	}
  }
